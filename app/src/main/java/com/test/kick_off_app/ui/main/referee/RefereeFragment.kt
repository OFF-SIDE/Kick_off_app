...
import com.test.kick_off_app.databinding.FragmentRefereeBinding
...
class RefereeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dashboardViewModel =
            ViewModelProvider(this).get(RefereeViewModel::class.java)

        _binding = FragmentRefereeBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textReferee
